...
import roleAdd from "../pages/sys/roleAdd.vue";
import roles from "../pages/sys/roles.vue";
...
import mxfw from "../pages/sfk/mxfw.vue";



//可视化
import kshsj from "../pages/sjksh/kshsj.vue";
import kshxs from "../pages/sjksh/kshxs.vue";
import kshgl from "../pages/sjksh/kshgl.vue";
import kshck from "../pages/sjksh/kshck.vue";
...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            // { path: '/sys/roleList', component: roles },
            ...
            { path: '/sfk/mxfw', component: mxfw },

            { path: '/sjksh', component: NotFoundView },
            { path: '/sjksh/kshsj/:token', component: kshsj },
            { path: '/sjksh/kshxs', component: kshxs },
            { path: '/sjksh/kshgl', component: kshgl },
            { path: '/sjksh/kshck', component: kshck },
